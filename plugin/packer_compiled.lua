...
local package_path_str = "/home/slave/.cache/nvim/packer_hererocks/2.1.1700008891/share/lua/5.1/?.lua;/home/slave/.cache/nvim/packer_hererocks/2.1.1700008891/share/lua/5.1/?/init.lua;/home/slave/.cache/nvim/packer_hererocks/2.1.1700008891/lib/luarocks/rocks-5.1/?.lua;/home/slave/.cache/nvim/packer_hererocks/2.1.1700008891/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "/home/slave/.cache/nvim/packer_hererocks/2.1.1700008891/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  ...
  ["auto-save.nvim"] = {
    ...
    loaded = true,
    path = "/home/slave/.local/share/nvim/site/pack/packer/start/auto-save.nvim",
  ...
  ["neoconf.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/slave/.local/share/nvim/site/pack/packer/opt/neoconf.nvim",
  ...
  neoformat = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/slave/.local/share/nvim/site/pack/packer/opt/neoformat",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp-signature-help", "cmp-path", "cmp-cmdline", "cmp-omni", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-calc", "cmp-buffer" },
  ...
  ["nvim-gdb"] = {
    loaded = true,
    path = "/home/slave/.local/share/nvim/site/pack/packer/start/nvim-gdb",
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-textobjects", "nvim-treesitter-refactor", "nvim-treesitter-pairs", "nvim-treesitter-context", "nvim-dap-virtual-text" },
  ...
  semshi = {
    loaded = true,
    path = "/home/slave/.local/share/nvim/site/pack/packer/start/semshi",
...
pcall(vim.api.nvim_create_user_command, 'Neoconf', function(cmdargs)
          require('packer.load')({'neoconf.nvim'}, { cmd = 'Neoconf', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'neoconf.nvim'}, {}, _G.packer_plugins)
          return vim.fn.getcompletion('Neoconf ', 'cmdline')
      end})
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-treesitter'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lspkind-nvim', 'lualine.nvim', 'which-key.nvim', 'vim-matchup', 'dashboard-nvim', 'vim-indent-object', 'bufferline.nvim', 'nvim-web-devicons', 'vim-swap'}, { event = "VimEnter *" }, _G.packer_plugins)]]
